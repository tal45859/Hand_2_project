...
export class AddImageComponent implements OnInit {
  ...
  public uploadFile = (files:any) => {
    ...
    if(!this.ResponseMessage.Isok)
    {
     ...
     this.AddImageToFolder(this.LastPostId?.toString()+fileToUpload.name);
  }
  ...
  async GetAllImage()
  {
   (await this.HttpImage.GetAllImageByPostId(Number(this.LastPostId))).subscribe((response)=>{this.AllNewImageArr=response});
  }
